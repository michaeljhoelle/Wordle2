...
export class WordleComponent implements OnInit {
  constructor(private wordClient: WordClient, private dialog: MatDialog, private route: ActivatedRoute) {}
  ...
  submitWord() {
    ...
    this.wordClient.verifyWord(this.rows[this.currentRow].letters.map(o => o.letter).join('').toLowerCase(), this.password)
